import {PrismaClient} from '@prisma/client'; import {Client} from 'minio'; import Redis from 'ioredis'; import amqp from 'amqplib'; import {DEAD_LETTER_QUEUE, PROCESSING_QUEUE, processingQueueOptions} from '@fluxocsv/shared/queue';
...
export const BUCKET = 'fluxocsv'; export const QUEUE = PROCESSING_QUEUE;
